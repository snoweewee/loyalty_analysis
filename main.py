...
class StudentAnalyzerApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        feature_descriptions = [
            "Активность на платформе (-3.0 до +3.0)",
            "Успеваемость (-3.0 до +3.0)",
            "Посещаемость занятий (-3.0 до +3.0)",
            "Вовлеченность в сообщество (-3.0 до +3.0)",
            "Использование доп. материалов (-3.0 до +3.0)",
            "Качество выполненных работ (-3.0 до +3.0)",
            "Продолжительность обучения (-3.0 до +3.0)"
        ]
